  ...
  return (
    <div>
      ...
      <div className="sm:w-420 flex-center flex-col ">
        ...
        <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12"> Login into you Account </h2>
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-5 w-full mt-4">
          ...
          <p className="text-small-regular text-light-3  text-center ">
            Dont have an account <Link to="/sign-up" className="text-black font-bold ml-1 "> Sign Up</Link>
          </p>
          <p className="text-small-regular text-light-3  text-center ">
